...
class RustAdapter(BaseTechAdapter):
    ...
    def plan_fix(self, error_ctx, repo_files): return FixPlan(files=[], changes={}, validation_commands=["cargo test", "cargo clippy"], root_cause=error_ctx.error_summary, tech="rust", fix_description="Fixed Rust compilation issue.")
